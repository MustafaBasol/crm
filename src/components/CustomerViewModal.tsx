          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 text-xs text-gray-600">
            <div>
              ...
              <div>
                ...
                <span className="font-medium">{customer.createdAt ? new Date(customer.createdAt).toLocaleString('tr-TR') : '—'}</span>
              </div>
            </div>
            <div>
              <div>
              ...
              <div>
                ...
                <span className="font-medium">{(customer as any).updatedAt ? new Date((customer as any).updatedAt).toLocaleString('tr-TR') : '—'}</span>
              </div>
            </div>
          </div>
          {/* Customer Info */}
