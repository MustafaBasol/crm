...
export default function SaleViewModal({ 
  ...
  const L = {
    ...
    customerInfo: { tr:'Hesap Bilgileri', en:'Account Information', fr:'Informations compte', de:'Accountinformationen' }[lang as 'tr'|'en'|'fr'|'de'] || 'Account Information',
    customer: { tr:'Hesap', en:'Account', fr:'Compte', de:'Account' }[lang as 'tr'|'en'|'fr'|'de'] || 'Account',
