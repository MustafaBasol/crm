...
export class AddEmailVerificationAndReset1762000000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "emailVerificationToken" varchar`);
        await queryRunner.query(`ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "emailVerificationSentAt" TIMESTAMP`);
        ...
        try { await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_users_emailVerificationToken ON "users" ("emailVerificationToken")`); } catch {}
        try { await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_users_passwordResetToken ON "users" ("passwordResetToken")`); } catch {}
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN IF EXISTS "emailVerificationSentAt"`);
