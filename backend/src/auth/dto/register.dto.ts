...
export class RegisterDto {
  ...
  @Matches(/^[a-zA-ZğüşöçıĞÜŞÖÇİ\s]+$/, { message: 'First name can only contain letters and spaces' })
  firstName: string;
  ...
  @Matches(/^[a-zA-ZğüşöçıĞÜŞÖÇİ\s]+$/, { message: 'Last name can only contain letters and spaces' })
  lastName: string;
